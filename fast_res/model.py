...
from loss import *
# from models.ECAPATDNN512_Teacher import *
from models.ResNetSE34L_Teacher import *
from tools import *
...
class model(nn.Module):
    def __init__(self, niter_per_ep=1092009, **kwargs): ##1240652, 1092009:Vox2, 148642:Vox1
        ...
        print("Model para number = %.2f"%(sum(param.numel() for param in self.SpeakerNet.parameters()) / 1024 / 1024))
    ...
    def train_network(self, loader, epoch):
        ...
        for counter, (data, label) in enumerate(loader, start = 1):
            ...
            # only for Downmodel 
            # utils.exclude_cancel_gradients_with_name(epoch, self.SpeakerNet, self.warmup_epochs,'backbone')
    ...
    def evaluate_network(self, val_list, val_path, **kwargs):
        ...
        for idx, file in tqdm.tqdm(enumerate(setfiles), total = len(setfiles)):
            ...
            # audio = audio[int(120):int(120)+160*300]
